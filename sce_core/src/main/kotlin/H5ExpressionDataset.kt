...
class H5ExpressionDataset(val h5path: String) {
    ...
    private fun <T> getSlice(datasetId: Int, start: Int, end: Int, result:T, type: Int) {
        ...
        val statusSlab = H5.H5Sselect_hyperslab(filespaceId, HDF5Constants.H5S_SELECT_SET, startArray, null, countArray, null)
