        ...
        return (
            <Tab.Pane>
                <div className="ui sizer vertical segment">
                    <div className="ui huge header">Single-cell explorer: beta</div>
                    <p>Single-cell explorer is an open-source project dedicated to processing and visualization of
